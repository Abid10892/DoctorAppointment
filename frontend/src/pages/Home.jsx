      ...
      <div className='container'>
        <div className='flex flex-col lg:flex-row gap[90px] items-center justify-between'>
          ...
          <div>
            ...
            <p className='text__para'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam, sed? Voluptates tempore quo, natus delectus totam blanditiis similique, pariatur eveniet ipsum numquam necessitatibus omnis rerum, harum quasi earum?</p>
