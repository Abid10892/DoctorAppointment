  ...
  return (
    <div className='mt-10'>
      <form onSubmit={submitHandler}>
            ...
            focus:border-b-primaryColor text-[16px] leading-7 text-headingColor
            placeholder:text-textColor rounded-md cursor-pointer' type="email" placeholder='Enter your Email' name='email' aria-readonly readOnly />
          </div>
          <div className="mb-5">
            ...
            focus:border-b-primaryColor text-[16px] leading-7 text-headingColor
            placeholder:text-textColor rounded-md cursor-pointer' type="password" placeholder='Enter your Password' name='password' />
          </div>
          <div className="mb-5">
            <input value={formData.bloodType} onChange={handleInputChange} className='w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none
            focus:border-b-primaryColor text-[16px] leading-7 text-headingColor
            placeholder:text-textColor rounded-md cursor-pointer' type="text" placeholder='Blood Type' name='bloodType' required />
          </div>
          ...
          <div className="mt-7">
            <button disabled={loading && true} type='submit' className='w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3'>
              {loading ? <HashLoader size={25} color='#ffffff'></HashLoader> : 'Update'}
            </button>
          </div>
