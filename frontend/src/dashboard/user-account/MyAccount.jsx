        ...
        {!loading && !error && <div className='grid md:grid-cols-3 gap-10'>
            <div className='pb-[50px] px-[30px] rounded-md'>
                <div className='flex items-center justify-center'>
                    <figure className='rounded-full w-[100px] h-[100px] border-2 border-solid border-primaryColor '>
                        <img src={userData.photo} alt="" className='rounded-full w-full h-full' />
                    </figure>
                </div>
